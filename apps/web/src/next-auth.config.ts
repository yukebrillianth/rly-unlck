 ...
 * used in middleware.
 */
// Prefer explicit NEXTAUTH_SECRET if provided, else fall back to validated SECRET_PASSWORD
const authSecret = process.env.NEXTAUTH_SECRET || env.SECRET_PASSWORD;
